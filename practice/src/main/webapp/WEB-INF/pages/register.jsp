...
<html>
	...
	<body>
		<div class="container" ng-app="app">
			<h1 style="text-align: center; color: aqua;">Register Here</h1><hr/>
			<div ng-controller ="registerController">
				<form style="text-align: center;" name="registerForm" novalidate method="post" ng-submit="submitClick()" onreset="resetClick()">
					<input type="text" name="userCode" ng-model="userCode" id="userId" placeholder="Enter UserCode here" ng-required="true">
					<span class="c1" ng-show="registerForm.userCode.$error.required && registerForm.userCode.$dirty">UserCode is required</span><br /> 
					<input type="password" name="password" id="password" placeholder="Enter Password here" ng-model="password"  ng-maxlength="25" ng-required="true" onfocus = "focusOn()" onblur = "focusOff()">
					<span style="font-size: 20px; display: table; margin-left: auto; margin-right: auto;" id="message"></span>
					<input type="password" name="cPassword" placeholder="Enter Confirm Password here" ng-model="cPassword" id="cPassword" ng-maxlength="25" ng-required="true" onfocus="passwordCheck()" onblur="passwordSame()">
					...
					<input type="text" name="firstName" placeholder="Enter First Name here" ng-model="firstName"id="fName" ng-required="true"> 
					<input type="text" name="middleName" ng-model="middleName" placeholder="Enter Middle Name here" id="mName"> 
					<input type="text" name="lastName" ng-model="lastName" placeholder="Enter Last Name here" id="lName" ng-required="true"> 
					<input type="email" name="email" ng-model="email" placeholder="Enter Email here" id="email" ng-required="true"> 
					<input type="text" name="mobile" placeholder="Enter Mobile here" ng-model="mobile" id="mobile" ng-maxlength="10" onblur= "validateMobile()" onkeypress="return AllowOnlyNumbers(event)" ng-required="true">
